...
const L = {
  vi: {
    ...
    chips: ["Giáo viên Mỹ có bằng sư phạm", "Giáo trình Oxford & Cambridge", "Tối đa 12 học sinh / lớp"],
    proof: [
      ["19", "học viên mùa hè 2026"],
      ["40", "ngày trại được ghi lại"],
    ...
    journey: [
      ...
      { img: "media/landing/journey-2.jpg", t: "Dự án & đôi tay", b: "Các con học bằng cách làm: xây mô hình, vẽ áp phích, thuyết trình. Kiến thức đi qua đôi tay để ở lại trong đầu." },
    ...
    journalKicker: "Món quà cuối trại",
    journalTitle: "Mỗi con tốt nghiệp với một cuốn nhật ký số của riêng mình.",
    journalBody: "Không phải giấy khen in sẵn. Mỗi gia đình HEC nhận một trang nhật ký riêng cho con: video nổi bật, bộ ảnh được chọn lọc qua cả mùa hè, video con tự kể về hành trình, và nhận xét song ngữ do giáo viên viết riêng — theo tinh thần đánh giá của các trường quốc tế.",
    ...
    why: [
      { t: "Giáo viên Mỹ có bằng sư phạm", b: "Con học phát âm, tư duy và văn hóa từ một nhà giáo dục thực thụ — kỹ sư chuyển ngành sư phạm, tận tâm với từng học sinh." },
      ...
      { t: "Học phí minh bạch 210.000₫/buổi", b: "Biết trước từng đồng, không gói triệu đồng mập mờ. Kèm Câu lạc bộ Đọc sách thứ Bảy hoàn toàn miễn phí." },
    ],
